...
<link rel="stylesheet" href="assets/assets/font-awesome/css/font-awesome.min.css" type="text/css">
<!-- Plugin CSS -->
<link rel="stylesheet" href="assets/assets/css/animate.min.css" type="text/css">
<!-- Custom CSS -->
...
<div class="container">
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand page-scroll" href="#page-top"><img width ="15px" heigt="5px" src="assets/assets/img2/harthotel3.png" alt="harthotel"></a>
	</div>
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand page-scroll" href="#page-top"><img width ="40px" heigt="5px" src="assets/assets/img2/harthotel2.png" alt="harthotel"></a>
	</div>
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		<ul class="nav navbar-nav navbar-right">
			...
			<li>
			<a class="page-scroll" href="#services">Event</a>
			</li>
			<li>
			<a class="page-scroll" href="#contact">Contact</a>
			</li>
			<li>
			<a class="page-scroll" href="http://hotelhart.000webhostapp.com/index.php/Home/">Sign up</a>
			</li>
...
<div id="carousel-example-generic" class="carousel intro slide">
	...
	<div class="carousel-inner" role="listbox">
		<!-- First slide -->
		<div class="item active" style="background-image:url(assets/assets/img2/2.jpg)">
		...
		<!-- /.item -->
		<!-- Second slide -->
		<div class="item" style="background-image:url(assets/assets/img2/1.jpg)">
			<div class="carousel-caption">
		...
		<!-- /.item -->
		<!-- Third slide -->
		<div class="item" style="background-image:url(assets/assets/img2/3.JPG)">
			<div class="carousel-caption">
...
<div class="col-md-4">
	<img src="assets/assets/img2/StR2.jpg" class="img-responsive" alt="">
</div>
<div class="col-md-4">
	<img src="assets/assets/img2/SuD2.jpg" class="img-responsive" alt="">
</div>
<div class="col-md-4">
	<img src="assets/assets/img2/SuT2.jpg" class="img-responsive" alt="">
</div>
...
<!--menampilkan gambar dari database buzz-->
...
<div class="row no-gutter">
	<div class="col-lg-4 col-sm-6">
		...
		<img src="assets/assets/img2/makan.jpg" class="img-responsive" alt="">
	...
	<div class="col-lg-4 col-sm-6">
		<a href="#" class="gallery-box">
		<img src="assets/assets/img2/resto.jpg" class="img-responsive" alt="">
		<div class="gallery-box-caption">
			<div class="gallery-box-caption-content">
				<div class="project-category text-faded">
					 Main Lobby
	...
	<div class="col-lg-4 col-sm-6">
		<a href="#" class="gallery-box">
		<img src="assets/assets/img2/karyawan.jpg" class="img-responsive" alt="">
		<div class="gallery-box-caption">
			<div class="gallery-box-caption-content">
				<div class="project-category text-faded">
					 Bathroom
	...
	<div class="col-lg-4 col-sm-6">
		<a href="#" class="gallery-box">
		<img src="assets/assets/img2/malam.jpg" class="img-responsive" alt="">
		<div class="gallery-box-caption">
			<div class="gallery-box-caption-content">
				<div class="project-category text-faded">
					 Towels
	...
	<div class="col-lg-4 col-sm-6">
		<a href="#" class="gallery-box">
		<img src="assets/assets/img2/restolobi.jpg" class="img-responsive" alt="">
		<div class="gallery-box-caption">
			<div class="gallery-box-caption-content">
				<div class="project-category text-faded">
					 Category
	...
	<div class="col-lg-4 col-sm-6">
		<a href="#" class="gallery-box">
		<img src="assets/assets/img2/resto2.jpg" class="img-responsive" alt="">
		<div class="gallery-box-caption">
			<div class="gallery-box-caption-content">
				<div class="project-category text-faded">
					 Category
...
<!-- Section Social
================================================== -->
<section id="social" class="parallax parallax-image" style="background-image:url(assets/assets/img2/2.jpg);">
...
<script src="assets/assets/js/countto.js"></script>
