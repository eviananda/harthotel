...
<!----->
       ...
       <div class="content-main">
        ...
        <h2>
         ...
         <a href="<?php echo base_url() . 'addBuzz' ?>"><button  type="button" class="btn btn-primary" style="float:right;"><i class="fa fa-plus-square"></i> Tambah Artikel</button></a>
         </ol>
      ...
      <div class="table-responsive">
        <table class="table table-bordered">
          ...
          <tbody>
              ...
              <td><?= $x['isi'] ?></td>
              <td><?= $x['tanggal'] ?></td>
              <td><img src="<?php echo base_url()."/assets/images/".$x['gambar']; ?>" width="150px" height="150px" > </td>
              <td align="center"> 
                <a href="<?php echo base_url()."MyController/do_edit/".$x['id_artikel']; ?>" >  Edit </a> ||
                <a href="<?php echo base_url()."MyController/deleteData/".$x['id_artikel']; ?>"> Delete </a>
                </td>
              </tr>
              <?php } ?>
          </tbody>
