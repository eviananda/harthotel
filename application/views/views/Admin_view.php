		   ...
		   <!-- Collect the nav links, forms, and other content for toggling -->
		    ...
		    <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                                ...
                                <li>
                                    <a href="layout.html" class=" hvr-bounce-to-right"><i class="fa fa-cog nav_icon"></i> <span class="nav-label">Admin Setting</span> </a>
                                </li>
      ...
      <div class="table-responsive">
        <table class="table table-bordered">
          ...
          <tbody>
              ...
              <td><?= $x['password'] ?></td>
              <td align="center"> 
                <a href="<?php echo base_url()."MemberController/edit_data/".$x['id_admin']; ?>" >  Edit  </a> 
                </td>
              </tr>
              <?php } ?>
          </tbody>
