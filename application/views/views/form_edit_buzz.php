...
<html>
<head>
<title>Admin Panel For Hart Hotels | Edit Artikel</title>
...
<!----->
      ...
      <div class="typo-1">
       <div class="grid_3 grid_4">
          <form method="POST" action="<?php echo base_url("MyController/do_update/$id_artikel");?>" enctype="multipart/form-data" >
            <?php
              $penyimpanan = $gambar;
            ?>
         <fieldset>
          <table>
             <div class="form-group">
              ...
              <div class="col-sm-10">
                 <input class="form-control" type="textarea" name="id_artikel" value="<?php echo $id_artikel; ?>" readonly>
              </div>
            </div>
            <div class="form-group">
              <label for="judul" class="control-label col-sm-2" >Judul :</label>
              <div class="col-sm-10">
                 <input class="form-control" type="textarea" name="judul" value="<?php echo $judul; ?>">
              </div>
            </div>
            <div class="form-group">
              <label for="isi" class="control-label col-sm-2" >Isi :</label>
              <div class="col-sm-10">
               <textarea name="isi" rows="10" cols="100"> <?php echo $isi; ?> </textarea>
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-2" for="tanggal" >Tanggal :</label>
              <div class="col-sm-10">
               <input class="form-control" type="text" name="tanggal" value="<?php echo $tanggal; ?>">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                 <td>
                <?php echo "<img src='http://localhost/hotelPbw/".$gambar."' class="."port-item".">"; ?> </br>
