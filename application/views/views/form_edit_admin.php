...
<html>
<head>
<title>Admin Panel For Hart Hotels | Admin Setting </title>
...
<!----->
      ...
      <div class="typo-1">
       <div class="grid_3 grid_4">
         ...
         <form method="POST" action="<?php echo base_url()."AdminController/do_update"; ?>  " class="form-horizontal">
          <table>
            <div class="form-group">
              <label class="control-label col-sm-2" >ID Admin :</label>
              <div class="col-sm-10">
                 <input class="form-control" type="textarea" name="id_admin" value="<?php echo $id_admin; ?>" readonly>
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-2" >Nama :</label>
              <div class="col-sm-10">
                 <input class="form-control" type="textarea" name="nama" value="<?php echo $nama; ?>">
              </div>
            </div>
            <div class="form-group">
